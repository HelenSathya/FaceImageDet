...
class _UpiPaymentScreenState extends State<UpiPaymentScreen> {
  ...
  final apiKey = 'AIzaSyAsWNfo_8kvZx8nqovE2Dhbc3VSzFtLvVs'; // Replace with your Google Cloud API key


  Future<UpiResponse> initiateTransaction(UpiApp app, String upiId, String name, String transactionNote, String amount) async {
